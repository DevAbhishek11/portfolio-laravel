...
@section('content')
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-zinc-400 text-sm mt-1">Share your thoughts, tutorials, or updates.</p>
        </div>
                ...
                <div class="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" id="blogTitle"
                            ...
                            value="{{ old('title') }}" placeholder="Enter an engaging title..." required>
                        @error('title')
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" rows="2"
                            ...
                            placeholder="A short summary for the blog feed (max 500 chars)...">{{ old('excerpt') }}</textarea>
            ...
            <div class="lg:col-span-4 space-y-6">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <div id="preview-container" class="space-y-2">
                                    ...
                                    <p class="text-[10px] text-zinc-500 uppercase font-bold">Upload Cover</p>
                                </div>
                                <img id="image-preview" class="hidden w-full h-32 object-cover rounded-lg">
                            </div>
                        </div>
                ...
                <div class="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="category" value="{{ old('category') }}" placeholder="e.g., Tech"
                    ...
                    <div>
                        ...
                        <input type="text" name="tags" value="{{ old('tags') }}" placeholder="laravel, php, web"
                            class="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-2 text-white text-sm outline-none">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" rows="3" placeholder="SEO summary..."
                            class="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-2 text-white text-sm outline-none">{{ old('meta_description') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('blogTitle').addEventListener('input', function() {
                    ...
                    document.getElementById('blogSlug').value = this.value
                        .toLowerCase().trim()
                        .replace(/[^\w\s-]/g, '')
                        .replace(/\s+/g, '-')
                        .replace(/-+/g, '-');
